...
function add25Min() {
    ...
    var contentArray = ["", "OKR 日記 and input & output", "OKR(skills)", "本", "Tech", "Rest (散歩)", "OKR", "YT(mindset)[実質OKR]", "Eat", "Mindfulness", "YT(学習)", "Intern", "Intern", "Rest", "OKR", "Intern", "Intern", "YT(学習)", "Rest", "Rest and eat", "Gym", "Gym", "Gym/行き来YT", "Rest", "Mindfulness for motivation", "本", "OKR", "Intern", "Intern", "Rest", "本", "Rest & eat", "Intern", "Intern", "本", "明日の予定を書く" ];
    i++;
