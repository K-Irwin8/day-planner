...
contentbox.value = "Masterplan 読む => Mindfulness(vizualize 特に)";
contentbox.id = "yay";
...
function add25Min() {
    ...
    var contentArray = ["", "部屋を掃除する", "Task と計画を書き出す", "Go to the cafe => OKR (skill の input & output と日記)", "OKR (skills)", "本", "YT (mindset)", "tech", "Rest", "OKR(skills)", "Intern", "Intern", "YT(学習)", "Rest", "本", "YT(mentor study)", "Eat & rest", "Eat & rest", "Eat & rest", "Masterplan 書き出す => Shaan method => vizualize (山)", "OKR", "Intern", "本", "Rest", "OKR", "本", "Eat & rest", "YT (mindset)", "OKR", "本", "Eat", "Gym", "Gym", "Gym", "Eat & rest", "YT (mentor study)", "Mindfulness", "Masterplan 読む => 書く => vizualize",  "[寝る前]明日の予定を立てる & vizualize"];
    i++;
